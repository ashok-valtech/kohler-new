...
@Path("/twwarrantyform/")
public class TWWarrantyFormService extends BaseRestResource {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(TWWarrantyFormService.class);
	...
	@Persistable
	public Map<String, String> createWarrantyForm(@Multipart("koh-warranty-card-number") String warrantyCardNo,
			@Multipart("koh-warranty-email") String email, @Multipart("koh-warranty-full-name") String name,
			@Multipart("koh-warranty-mobile") String mobile, @Multipart("koh-warranty-purchased") String countyOrCity,
			@Multipart("koh-warranty-address") String address,
			@Multipart("koh-warranty-product-delivery") String deliveryDate,
			@Multipart("koh-warranty-Store") String buyingLocation,
			@Multipart("koh-warranty-product-name") String itemNo,
			@Multipart("koh-warranty-product-serial-number") String productSerialNo,
			@Multipart("koh-warranty-choose") String everPurchasedKohler,
			@Multipart("koh-warranty-about-kohler") String knowAboutKohler,
			@Multipart("koh-warranty-suggestions") String advice,
		...
		try {
			...
			JSONObject jsonData = createFormJson(warrantyCardNo, email, name, mobile, address, productDeliveryDate,
					countyOrCity, buyingLocation, itemNo, productSerialNo, everPurchasedKohler, knowAboutKohler, advice,
					kohlerPrivacyPolicy, kohlercontactInfo, fileUploadUrl);
	...
	public JSONObject createFormJson(String warrantyCardNo, String email, String fullName, String mobile,
			String address, String productDeliveryDate, String cityName, String buyingLocation, String itemNo,
			String productSerialNo, String everPurchasedKohler, String knowAboutKohler, String advice,
			boolean privacyPolicy, boolean contactInfo, String filePath) {

		JSONObject json = new JSONObject();
		JSONArray array = new JSONArray();
		JSONObject formData = new JSONObject();
		
		formData.put("Warranty Card No", warrantyCardNo);
		formData.put("Email", email);
		formData.put("Full Name", fullName);
		formData.put("Mobile Number", mobile);
		formData.put("Address", address);
		formData.put("Product Delivery Date", productDeliveryDate);
		formData.put("County or City", cityName);
		formData.put("Where Purchased", buyingLocation);
		formData.put("Product Model Number_Name", itemNo);
		formData.put("Product Serial Number", productSerialNo);
		formData.put("Have you purchased with Kohler before", everPurchasedKohler);
		formData.put("Where did you hear about Kohler", knowAboutKohler);
		formData.put("Suggestions for Kohler", advice);
		formData.put("Kohler Privacy", privacyPolicy);
		formData.put("Special Offers Optin", contactInfo);
