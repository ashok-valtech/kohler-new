...
axKOH.main.carouselManager = (function () {
    ...
    var initCarousel = function () {
        ...
        var $components = $(".c-koh-banner-carousel"), slidesToShow;
        ...
        $components.each(function (componentIndex, element) {
			...
			var isArticle = $(element).hasClass('v-koh-article');
	        ...
	        //     	$(".c-koh-banner-carousel").first().css("margin-top", "40px");
	        //     }
            // }else {
            //     if (window.screen.width < smallScreenWidth) {
	        //     	$(".c-koh-banner-carousel").css("margin-top", "55px");
	        //     }
            // }
            ...
            $carousels.each(function (carouselIndex, ele) {
                ...
                if ($(window).width() < smallScreenWidth) {
                    ...
                    config = Object.assign(config,mobileConfig);
                }
				...
				if(isArticle){
                    config['dotsClass'] = "koh-article-carousel-indicators";
                    config['autoplay'] = true;
                }
                ...
                $slideCollection
                    .slick(config).on('afterChange', function (event, slick, slideIndex) {
                        ...
                        repositionControlsHeroBanner($carouselControls, $slide);
                    });
                ...
                $(window).load(function () {
                    repositionControlsHeroBanner($carouselControls, $firstSlide);
                });
    ...
    // shopping guide carousel components starts from here
    
    var initShoppingGuideCarousel = function () {
        // Locate all instances of the component
        ...
        $components.each(function (componentIndex, element) {
            ...
            // if (ribbonItemCount == 0) {
	        //     if (window.screen.width < 1023) {
	        //     	$(".c-koh-shopping-guide-carousel").first().css("margin-top", "40px");
	        //     }
            // }else {
            //     if (window.screen.width < 1023) {
	        //     	$(".c-koh-shopping-guide-carousel").css("margin-top", "55px");
	        //     }
            // }
            ...
            $carousels.each(function (carouselIndex, ele) {
                ...
                $slideCollection
                    .slick(config).on('afterChange', function (event, slick, slideIndex) {
                        var $slide = $(slick.$slides.get(slideIndex));
                        repositionControlsShoppingGuide($carouselControls, $slide);
                    });
                ...
                // can position the controls accordingly.
                $(window).load(function () {
                    repositionControlsShoppingGuide($carouselControls, $firstSlide);
                });
                $(window).resize(function () {
                    waitForFinalEvent(function () {
                        repositionControlsShoppingGuide($carouselControls, $firstSlide);
    ...
    var repositionControlsHeroBanner = function ($controlsContainer, $referenceSlide) {
        var bgWidth = "";
        var bgHeight = "";

        var $bannerBg = $(window).width() < smallScreenWidth ? $referenceSlide.children(".koh-banner-background-mobile").first()  : $referenceSlide.children(".koh-banner-background").first();
    ...
    var repositionControlsShoppingGuide = function ($controlsContainer, $referenceSlide) {
        var bgWidth = "";
        var bgHeight = "";
    ...
    var initSlides = function ($slideCollection, containerID) {
        ...
        $slides.each(function (slideIndex) {
            ...
            //hide banner title & banner summary on mobile screens

            var url = new URL(window.location.href);
            var path = url.pathname;
            if(path === "/" || path === "/en") {
                if($(window).width() < smallScreenWidth) {
                    $(".v-koh-hero").find(".koh-banner-title").hide();
                    $(".v-koh-hero").find(".koh-banner-summary").hide();        
                }
            }
