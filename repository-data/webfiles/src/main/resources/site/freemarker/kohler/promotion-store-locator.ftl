...
<@fmt.message key="promo-store-locator-entity-ids" var="promoStoreLocatorEntityIds"/>
...
<#if promoStoreLocatorEntityIds?? && promoStoreLocatorEntityIds?has_content>
	<input type="hidden" id="promoStoreLocatorEntityIds" value="${promoStoreLocatorEntityIds}">
</#if>
	...
	<section class="c-koh-store-locator">
		<div class="container">
	        <div class="koh-map-form-inner-content">
	           <h1 class="text-center koh-map-mu-promotion-header">${findAStore}</h1>
...
<@hst.headContribution category="ext-scripts">
    <script type="text/javascript" src="${link}/js/custom/koh-promotion-store-locater.min.js"></script>
</@hst.headContribution>
