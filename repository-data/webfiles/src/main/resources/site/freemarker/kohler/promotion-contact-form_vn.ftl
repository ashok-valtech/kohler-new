...
<@fmt.message key="mu-interested-product-drop-down-value7-others" var="others"/>
...
<section class="c-koh-contact-form">
        <div class="koh-mu-contact-container">
            ...
            <#--     <div class="form-group">
                        ...
                        <div class="col-sm-4">          
                            <input type="text" class="form-control" id="koh-contact-facebook" placeholder="" name="facebook" maxlength="40">
                        </div>
                    </div>  -->  
                    
                     <input type="hidden" class="form-control" id="koh-contact-facebook" maxlength="60" placeholder="" name="facebook" value="NA">
