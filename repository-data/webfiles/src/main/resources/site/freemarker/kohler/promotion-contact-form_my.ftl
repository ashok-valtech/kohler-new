...
<@fmt.message key="contact-form-selectstoreName" var="selectstoreName"/>
<@fmt.message key="contact-form-store-drop-down-values" var="selectstorevalues"/>
               ...
               <form class="form-horizontal"  action="<@hst.actionURL escapeXml=false />" method="post" name="${form.name!}" id="mucontactUsForm"
                 <#if form.multipart>enctype="multipart/form-data"</#if> autocomplete="off" >
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="control-label col-sm-5" for="koh-contact-store">${selectstoreName}</label>
                        <div class="col-sm-4">          
                             <select class="form-control" id="koh-contact-store" name="selectstore">
                                <option value="">${select}</option>
                              <#list selectstorevalues?split(",") as preferredStoreValue>
                  ...
                  <div class="form-group">
                      ...
                      <#-- <input type="hidden" class="form-control" id="koh-contact-score" maxlength="60" placeholder="" name="score" value="NA"> -->
