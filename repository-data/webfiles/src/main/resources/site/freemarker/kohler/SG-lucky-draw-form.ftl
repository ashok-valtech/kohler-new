...
<@fmt.message key="warranty-contact-subtitle" var="subTitle"/>
...
<@fmt.message key="warranty-store-location-pdf" var="storeLocationPDF"/>
<@fmt.message key="warranty-pdf-title" var="pdfTitle"/>
<@fmt.message key="warranty-invalid-date-error-message" var="invalidDateErrorMessage"/>



<@hst.link var="luckyDrawThankyou" siteMapItemRefId="luckyDrawThankyou"/>
...
<input type="hidden" id="koh-warranty-thankyouPage" value=${luckyDrawThankyou}>
        ...
        <div class="koh-contact-container">
            <div class="koh-contact-header">
                ...
                <div class="form-group">
                	<h4 class="text-center">${subTitle}</h5>
            	</div>
 				<span class="koh-contact-require">${required}</span>
            </div>
            <div class="koh-contact-form-wrapper">
                <form method="POST" class="form-horizontal" action="${englishSite}/api/sgluckydraw" enctype="multipart/form-data" id="sgLuckyDrawForm" autocomplete="off">
                	...
                	<div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="koh-warranty-salutation" placeholder="${salutationPlaceholder}" name="koh-warranty-salutation">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">          
                            <input type="text" class="form-control" id="koh-warranty-full-name" name="koh-warranty-full-name">
                        </div>
                    </div>
                	...
                	<div class="form-group">
                        ...
                        <div class="col-sm-4">          
                            <input type="text" class="form-control" id="koh-warranty-email" maxlength="60" placeholder="" name="koh-warranty-email">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">          
                            <input type="text" class="form-control" id="koh-warranty-mobile" placeholder="" name="koh-warranty-mobile" maxlength="20">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">   
                            <textarea class="form-control" rows="5" id="koh-warranty-address" name="koh-warranty-address"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                    	<label class="control-label col-sm-5" for="koh-warranty-product-delivery">${deliveryDate}</label>
                    	<div class="col-sm-4">
		            ...
		            <div class="form-group">
                        <label class="control-label col-sm-5" for="koh-warranty-choose">${purchased}</label>
                        <div class="col-sm-4">
					...
					<div class="form-group">
                       <label class="control-label col-sm-5 koh-upload-label" for="koh-contact-upload-file">${uploadLabel}</label>
                        <div class="col-sm-4">   
                    ...
                    <div class="form-group">
						<div class="form-group koh-content-promo">
							<a href="${storeLocationPDF}" target="_blank">${pdfTitle}</a>
						</div>
					</div>
                </form>
            </div>
...
<@hst.headContribution category="ext-scripts">
    <script type="text/javascript" src="${link}/js/custom/koh-SG-lucky-draw-form.min.js"></script>
