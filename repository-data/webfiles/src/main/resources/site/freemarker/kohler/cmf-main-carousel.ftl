...
<#if document??>
	<section class="c-koh-cmf-main-carousel">
		<div class = "koh-cmf-main-carousel-container">
			<#if document.title.content?? && document.title.content?has_content>
	        	<div class="koh-cmf-main-carousel-title"><@hst.html hippohtml=document.title/></div>
	        </#if>	
				<div class="koh-cmf-main-carousel-banner">
						...
						<div class="koh-carousel koh-theme-dark">
			  			...
			  			<#if document.promotionLink?? && document.promotionLink?has_content>
	                        ...
	                        <a href="${promotionLink}"  target="${target}"> 
					   			<button id="koh-cmf-main-carousel-broucher"  class="btn btn-default"><#if document.promotionButton?? && document.promotionButton?has_content>${document.promotionButton}</#if></button>
					   		</a>	
				   		</#if>
		    		</div>		    
	     		</section>
