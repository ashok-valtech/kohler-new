...
<#if document??>
	<section class="koh-three-image-product-carousel">
	   <div class="koh-product-carousel">
						...
						<div class="koh-product-carousel-ctas">
							...
							<#if item.viewAllLink?? && item.viewAllLink?has_content>
								...
								<#if item.viewAllLabel?? && item.viewAllLabel?has_content>
	                      			<a href="${viewAllLink}" target="${target}" class="koh-product-carousel-locator-btn">${item.viewAllLabel}</a>
	                      		</#if>
							</#if>
						</div>
					</div>
